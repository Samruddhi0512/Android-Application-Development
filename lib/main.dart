import 'package:login_page1/utility.dart';
import 'package:flutter/material.dart';
import 'package:login_page1/register_page.dart';
import 'package:login_page1/configurations.dart';
import 'package:login_page1/home_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void validate() {
    ...
    if (_userIDErrorText == null && _passwordErrorText == null) {
      ...
      for (var user in Configurations.credentials) {
        if (user['userid'] == _userID.text &&
      ...
      if (isValidUser) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => HomePage(userId: _userID.text),
          ),
        );
      } else {
